    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-black text-gray-900 dark:text-white">Create New Post</h2>
            </div>

            <form action="{{ route('instructor.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" placeholder="Enter a catchy title..." required
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="15" placeholder="Start writing your thoughts here..." required
                                  class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border-none rounded-2xl text-sm focus:ring-2 focus:ring-blue-500/20 dark:text-white">{{ old('content') }}</textarea>
                ...
                <div class="flex justify-end gap-4">
                    <button type="reset" class="px-8 py-3 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-white rounded-2xl font-bold hover:bg-gray-200 transition-all">
                        Reset
                    </button>
                    <button type="submit" class="px-10 py-3 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/25">
                        Publish Post
                    </button>
                </div>
            </form>
