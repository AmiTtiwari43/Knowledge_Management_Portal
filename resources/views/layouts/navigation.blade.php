                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @if(Auth::user()->role === 'instructor')
                            ...
                            <x-nav-link :href="route('instructor.posts.index')" :active="request()->routeIs('instructor.posts.*')">
                                {{ __('Manage Blogs') }}
                            </x-nav-link>
                        @endif
            ...
            @auth
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            @if(Auth::user()->role === 'student')
                                <x-dropdown-link :href="route('student.achievements')">
                                    {{ __('Achievements') }}
                                </x-dropdown-link>
                            @endif
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @if(Auth::user()->role === 'instructor')
                    ...
                    <x-responsive-nav-link :href="route('instructor.posts.index')" :active="request()->routeIs('instructor.posts.*')">
                        {{ __('Manage Blogs') }}
                    </x-responsive-nav-link>
                @endif
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    @if(Auth::user()->role === 'student')
                        <x-responsive-nav-link :href="route('student.achievements')">
                            {{ __('Achievements') }}
                        </x-responsive-nav-link>
                    @endif
